            ...
            return [2 /*return*/, {
                    next: function () {
                        if (_this.currentIndex < _this.songs.length) {
                            var song = _this.songs[_this.currentIndex];
                            _this.currentIndex++;
...
for (var _i = 0, playlist_1 = playlist; _i < playlist_1.length; _i++) {
    var song = playlist_1[_i];
    console.log("Now playing: ".concat(song));
}
